...
Welcome to district-control (working title)
===========================================

This repository provides an accessible and slim toolkit to use the power of PyPSA in the context of **Model predictive control**.
...
The following is a boiled down version of `this example notebook <https://github.com/LukasFrankenQ/district_control/blob/master/examples/basic_example.ipynb>`_,
...
The repository will next be expanded in two directions:

* Allow usage of machine learning models in ``prophet.py``.
* Add an **error management state** which corrects control for prediction errors.